  ...
  useEffect(() => {
    ...
    try {
      ...
      if (docStatusRaw) {
        ...
        const doc = docStatus?.leaseDocument;

        if (doc?.status === "approved" || doc?.verified === true) {
    ...
    setReady(true);
  }, [user, isLoading, router, getDocStatusKey, getAppointmentKey]);
