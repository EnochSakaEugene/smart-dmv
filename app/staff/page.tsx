      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <Link href="/staff/review?filter=ai-approved">
              <Button variant="outline" className="h-auto w-full justify-start gap-2 py-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-600"><circle cx="12" cy="12" r="10"/><polyline points="20 6 9 17 4 12"/></svg>
                <div className="text-left">
                  <p className="font-medium">AI Approved</p>
